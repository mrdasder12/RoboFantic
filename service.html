...
<html dir="ltr" lang="en-US">
    ...
    <head>
        ...
        <title>Meménto | Another nice WP theme by YIW</title>
            ...
            <div id="header" class="group">
                <div class="group inner">
                    ...
                    <div id="logo" class="group">
                        <h1>
                            <a class="logo-text" href="index.html" title="Mem&eacute;nto">Mem<span>é</span>nto</a>                        
                        </h1>
		    ...
		    <div class="inner group">
		            ...
		            <div class="posts">
		                <div class="bl_services type-bl_services status-publish hentry hentry-post group internal-post">
		                    ...
		                    <div class="post_header group">
		                        <img width="700" height="230" src="images/services/socialmarketing.jpg" class="internal wp-post-image" alt="socialmarketing" title="socialmarketing" />                            
		                    </div>
		                    <div class="post_content group">
		                        <p>Pellentesque tincidunt, sem in auctor fringilla, dui diam aliquam felis, nec rhoncus libero magna in nisi.</p>
		                        <p>Pellentesque tincidunt, sem in auctor fringilla, dui diam aliquam felis, nec rhoncus libero magna in nisi. Fusce venenatis tortor quis ligula sodales nec mollis ligula placerat. Morbi augue ligula, <strong>vehicula id vulputate sit amet,</strong> varius vitae nibh. Vivamus scelerisque nibh eget sapien porttitor interdum. Mauris lobortis diam quis nisl dictum dapibus. Fusce sit amet nibh sapien, id pulvinar mi. Mauris eget lacus leo. <a href="#">Cras sagittis</a> eros et lectus mollis varius gravida eros mattis. Nam et tristique leo.</p>
		                    </div>
		                    <div class="post_ group">
		                        <span class="edit-link"><a class="post-edit-link" href="#" title="Edit Service">Edit</a></span>    
		                    </div>
		                </div>
		            </div>
		        </div>
		        ...
		        <div id="sidebar" class="group one-fourth last">
		            ...
		            <div id="text-image-5" class="widget-1 widget-first widget text-image">
		                <h3>Purchase this theme <span>now!</span></h3>
		                <div class="text-image" style="text-align:left"><img src="images/enjoy.jpg" alt="Purchase this theme [now!]" /></div>
		                <p>A creative & corporate theme for your portfolio or brand site. Unlimited options and styles to create an unique layout. Enjoy it now!<br />
		                    <br />
		                </p>
		            </div>
		            ...
		            <div class="widget-first widget popular-posts">
		                ...
		                <div class="recent-post group">
		                    ...
		                    <div class="hentry-post group">
		                        <div class="thumb-img"><img width="55" height="55" src="images/blog/blog1-55x55.jpg" class="attachment-thumb_recentposts wp-post-image" alt="blog1" title="blog1" /></div>
		                    ...
		                    <div class="hentry-post group">
		                        <div class="thumb-img"><img width="55" height="55" src="images/blog/Fotolia_2885999_Subscription_XL-720x367-55x55.jpg" class="attachment-thumb_recentposts wp-post-image" alt="Fotolia_2885999_Subscription_XL-720x367" title="Fotolia_2885999_Subscription_XL-720x367" /></div>
		                    ...
		                    <div class="hentry-post group">
		                        <div class="thumb-img"><img width="55" height="55" src="images/blog/Fotolia_26908_Subscription_XL-720x296-55x55.jpg" class="attachment-thumb_recentposts wp-post-image" alt="Fotolia_26908_Subscription_XL-720x296" title="Fotolia_26908_Subscription_XL-720x296" /></div>
